...
- Delete a completed task on delete icon is clicked.

In this first project of the React todo app application. I set up the environment and tools needed to develop a React application and used components, props, state, and hooks, by following a tutorial.
...
cd my-folder
git clone git@github.com:Besufekad-HAZ/React-to-do-app.git (SSH)
